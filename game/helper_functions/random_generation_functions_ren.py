...
from game.clothing_lists_ren import diamond_ring, modern_glasses, big_glasses, sweater_dress, white_skin, tan_skin, black_skin, tan_list, copper_bracelet, gold_bracelet, colourful_bracelets
...
def make_person(name = None, name_list = None, last_name = None, last_name_list = None, age = None, age_range = None, body_type = None, body_type_list = None, face_style = None, face_style_list = None, tits = None, tits_range = None, height = None, height_range = None,
    ...
    if return_character is None: #Either we aren't getting a pre-made, or we are out of them.
        return_character = create_random_person(name = name, name_list = name_list, last_name = last_name, last_name_list = last_name_list, age = age, age_range = age_range, body_type = body_type, body_type_list = body_type_list, face_style = face_style, face_style_list = face_style_list, tits = tits, tits_range = tits_range, height = height, height_range = height_range,
            ...
            sex_cap=sex_cap, hymen = hymen, vaginal_virgin = vaginal_virgin, anal_virgin = anal_virgin, oral_virgin = oral_virgin, vaginal_first = vaginal_first, anal_first = anal_first, oral_first = oral_first,
...
def create_random_person(name = None, name_list = None, last_name = None, last_name_list = None, age = None, age_range = None, body_type = None, body_type_list = None, face_style = None, face_style_list = None, tits = None, tits_range = None, height = None, height_range = None,
        ...
        sex_skill_array = None, sex_skill_range_array = None, sluttiness = None, sluttiness_range = None, obedience = None, obedience_range = None, happiness = None, happiness_range = None, love = None, love_range = None, start_home: Room | None = None, tan_style = None, serum_tolerance = None,
        title = None, possessive_title = None, mc_title = None, relationship = None, relationship_list = None, kids = None, kids_range = None, kids_floor = None, kids_ceiling = None, SO_name = None, SO_name_list = None, base_outfit = None, base_outfit_list = None,
        generate_insta = None, generate_dikdok = None, generate_onlyfans = None,
        sex_cap=8, hymen = None, vaginal_virgin = 0, anal_virgin = 0, oral_virgin = 0, vaginal_first = None, anal_first = None, oral_first = None,
    ...
    if relationship is None:
        ...
        if age <=18 and (type!="story" or type!="unique"): relationship = "Single"
...
### ADDING THE Virginal Tracker Script
    ...
    if sex_skill_array is None:
        sex_skill_array = [renpy.random.randint(0,sex_cap),renpy.random.randint(0,sex_cap),renpy.random.randint(0,sex_cap),renpy.random.randint(0,sex_cap)]
    ...
    person = Person(name, last_name, age, body_type, tits, height, body_images, hair_colour, hair_style, pubes_style, skin, eyes, job, starting_wardrobe, personality,
        ...
        generate_insta = generate_insta, generate_dikdok = generate_dikdok, generate_onlyfans = generate_onlyfans,
        hymen = hymen, vaginal_virgin = vaginal_virgin, anal_virgin = anal_virgin, oral_virgin = oral_virgin, vaginal_first = vaginal_first, anal_first = anal_first, oral_first = oral_first,
...
def get_premade_character(age_range, tits_range, height_range, kids_range, relationship_list):
    ...
    if recruitment_skill_improvement_policy.is_active:
        person.hr_skill += renpy.random.randint(1, 4)
        person.market_skill += renpy.random.randint(1, 4)
        person.research_skill += renpy.random.randint(1, 4)
        person.production_skill += renpy.random.randint(1, 4)
        person.supply_skill += renpy.random.randint(1, 4)

    if recruitment_stat_improvement_policy.is_active:
        person.charisma += renpy.random.randint(1, 4)
        person.int += renpy.random.randint(1, 4)
        person.focus += renpy.random.randint(1, 4)
...
def get_party_destinations():
    ...
    def add_party_destination_by_room(room):    # add correct room object from list_of_places (prevents people disappearing)
        if found := next((x for x in list_of_places if x.name == room.name), None):
            party_destinations.append(found)

    for room in (downtown_bar, downtown_hotel, downtown, hospital):
